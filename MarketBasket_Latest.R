...
getwd()
setwd("D:\\Certifications\\Business Analytics_Henry_Horn")
getwd()
...
retail <- read_excel('D:\\Certifications\\Business Analytics_Henry_Horn\\Training-master/Online_Retail.xlsx')
retail
